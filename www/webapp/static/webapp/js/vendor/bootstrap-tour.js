    ...
    Tour = (function() {
      function Tour(options) {
        this._options = $.extend({
          ...
          template: function(i, step) {
            return "<div class='popover tour'>            <div class='arrow'></div><a href='#' class='close end'><i class='picto-delete'></i></a>            <h3 class='popover-title'></h3>            <div class='popover-content'></div>          </div>";
          },
      ...
      Tour.prototype._showPopover = function(step, i) {
        var $element, $tip, content, options,
          _this = this;
        content = "" + step.content + "<br /><p class='clearfix'>";
